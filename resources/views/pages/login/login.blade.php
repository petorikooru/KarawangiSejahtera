...
<body>
    <div class="daftar-user">
        ...
        <div class="daftar-user__container">
            <h1 class="daftar-user__title">Masuk</h1>

            <main class="daftar-user__form" aria-label="Form pendaftaran">
                <div class="form-group">
                    <label class="form-input" for="fullname">
                        <span class="form-input__icon"> <img src="{{'/images/png/email.png'}}" width="15px" height="15px"
                                alt="Akun"></span>
                ...
                <main class="daftar-user__form" aria-label="Form pendaftaran">
                    <div class="form-group">
                        <label class="form-input" for="Password">
                            <span class="form-input__icon"> <img src="{{'/images/png/lock.png'}}" width="15px" height="15px"
                                    alt="Akun"></span>
                ...
                <div class="form-footer_column">
                    <div class="form-footer_row">
                        ...
                        <p class="form-footer__text_right">
                            <a href="#" class="form-footer__link">Lupa password?</a>
                        </p>
                    </div>
